    ...
    return (
        <div className='slideshow'>
            {images.map( (img, index) => (
                    ...
                    <img src={img} alt={`${text}-${index+1}`} key={index+1} className={`slideshow__img ${index+1 === indexImg ? 'active' : ''}`} />
            ...
            {indexMax > 1 ? (
                <>
                    <nav className='slideshow__nav'>
                        <i className="fa-solid fa-chevron-left slideshow__nav--left" onClick={prevImg}></i>
                        <i className="fa-solid fa-chevron-right slideshow__nav--right" onClick={nextImg}></i>
                    </nav>
