            ...
            <nav className="navbar">
                <ul className="navbar__list">
                    <li className="navbar__item">
                        <Link to="/" className={`navbar__link ${estActive === "Accueil" ? "navbar__link--selected" : ""}`} onClick={() => setEstActive("Accueil")}>Accueil</Link>
                    </li>
                    <li className="navbar__item">
                        <Link to="/about" className={`navbar__link ${estActive === "A Propos" ? "navbar__link--selected" : ""}`} onClick={() => setEstActive("A Propos")}>A Propos</Link>
                    </li>
                </ul>
            </nav>
        </header>
